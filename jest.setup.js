...
jest.mock( '@wordpress/compose', () => ( {
	...
	createHigherOrderComponent: jest.fn( ( callback, name ) => ( Component ) => Component ),
...
jest.mock( '@wordpress/components', () => {
	...
	return {
		Button: ( { children, onClick, onKeyDown, ref, variant, isDestructive, disabled, size } ) =>
		...
		Flex: ( { children, justify, align, gap } ) =>
			React.createElement( 'div', {
				className: 'wp-flex',
				style: { display: 'flex', justifyContent: justify, alignItems: align, gap },
			}, children ),
		FlexItem: ( { children } ) =>
			React.createElement( 'div', { className: 'wp-flex-item' }, children ),
		...
		Modal: ( { title, children, onRequestClose, size } ) =>
			React.createElement( 'div', {
				...
				React.createElement( 'div', {
					...
					React.createElement( 'div', { key: 'header', className: 'components-modal__header' }, [
						React.createElement( 'h1', { key: 'title' }, title ),
					] ),
					React.createElement( 'div', { key: 'body' }, children ),
				] ),
			] ),
		SelectControl: ( { label, value, options, onChange, disabled, help } ) =>
			React.createElement( 'div', { className: 'components-base-control' }, [
				React.createElement( 'label', { key: 'label', className: 'components-base-control__label' }, label ),
				...
				help && React.createElement( 'p', { key: 'help', className: 'components-base-control__help' }, help ),
			] ),
		TextControl: ( { label, value, onChange, placeholder, onKeyDown, ref } ) =>
			React.createElement( 'div', { className: 'components-base-control' }, [
				React.createElement( 'label', { key: 'label', className: 'components-base-control__label' }, label ),
				React.createElement( 'input', {
					key: 'input',
